...
<!----------------------------------------------------------------->
    <div class="main-content">
        <div class="wrap">
            <div class="main-box">
               <div class="box_wrapper"><h1>AUDI RS <img class="hot" src="./asset/audi/audi-logo.png" alt=""></h1></div>  
            </div>
        </div>
    </div>
...
<!----------------------------------------------------------------->
    <div class="header-bottom">
        <div class="wrap">
            <div class="single">
                    <div class="box_wrapper"><h6>AUDI RS 7: (Rs 2.56 Cr*)</h6>
                    </div>	
                    <div>
              
                            <a href="audirs7.php"><img class="img-fluid img-responsive" src="./asset/audi/audi_rs_7(1.jpg" alt=""></a>
