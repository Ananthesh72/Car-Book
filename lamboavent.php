...
<!----------------------------------------------------------------->
    <div class="main-content">
        <div class="wrap">
            <div class="main-box">
               <div class="box_wrapper"><h1>LAMBORGHINI AVENTADOR <img class="hot" src="./asset/lamb/lambo_logo.png" alt=""></h1></div>  
            </div>
        </div>
    </div>
...
<!----------------------------------------------------------------->
    <div class="header-bottom">
        <div class="wrap">
            <div class="single">
                    <div class="box_wrapper"><h6>LAMBORGHINI AVENTADOR : (Rs 1.29 Cr*)</h6>
                    </div>	
                    <div>
              
                            <a href="bmwx1.html"><img class="img-fluid img-responsive" src="./asset/lamb/lamborghini_aventador_3.jpg" alt=""></a>
