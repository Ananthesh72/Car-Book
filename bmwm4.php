...
<!----------------------------------------------------------------->
    <div class="main-content">
        <div class="wrap">
            <div class="main-box">
               <div class="box_wrapper"><h1>BMW M4 <a href="http://localhost/dbms/bmw.php"> <img class="hot" src="./asset/pics/bmw_logo.png" alt=""></a></h1></div>  
            </div>
        </div>
    </div>
...
<!----------------------------------------------------------------->
    <div class="header-bottom">
        <div class="wrap">
            <div class="single">
                    <div class="box_wrapper"><h6>BMW M Series M4 Coupe : (Rs 1.65 Cr*)</h6>
                    </div>	
                    <div>
              
                            <a href="bmwm4.php"><img class="img-fluid img-responsive" src="./asset/pics/M4.jpg" alt=""></a>
