...
<!----------------------------------------------------------------->
    <div class="header-bottom">
        <div class="wrap">
            <div class="single">
                    <div class="box_wrapper"><h6>Ferrari SF90 Stradale: (Rs 4.24 Cr*)</h6>
                    </div>	
                    <div>
              
                            <a href="./asset/ferrari/ferrari_sf90.jpg"><img class="img-fluid img-responsive" src="./asset/ferrari/ferrari_sf90.jpg" alt=""></a>
