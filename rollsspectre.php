...
<!----------------------------------------------------------------->
    <div class="main-content">
        <div class="wrap">
            <div class="main-box">
               <div class="box_wrapper"><h1>Rolls Royce Spectre <img class="hot" src="./asset/rollls/Rolls-Royce_logo_PNG1.png" alt=""></h1></div>  
            </div>
        </div>
    </div>
...
<!----------------------------------------------------------------->
    <div class="header-bottom">
        <div class="wrap">
            <div class="single">
                    <div class="box_wrapper"><h6>Rolls Royce Boat Spectre: (Rs 2.56 Cr*)</h6>
                    </div>	
                    <div>
              
                            <a href="rollsspectre.php"><img class="img-fluid img-responsive" src="./asset/rollls/rolls_royce_spectre.jpg" alt=""></a>
