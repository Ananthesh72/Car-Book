...
<head>
    ...
    <title>Rolls Royce Black Badge</title>
...
<!----------------------------------------------------------------->
    <div class="main-content">
        <div class="wrap">
            <div class="main-box">
               <div class="box_wrapper"><h1>Rolls Royce Black Badge <img class="hot" src="./asset/rollls/Rolls-Royce_logo_PNG1.png" alt=""></h1></div>  
            </div>
        </div>
    </div>
...
<!----------------------------------------------------------------->
    <div class="header-bottom">
        <div class="wrap">
            <div class="single">
                    <div class="box_wrapper"><h6>Rolls Royce Black Badge Price: (Rs 2.56 Cr*)</h6>
                    </div>	
                    <div>
              
                            <a href="rollsbb.php"><img class="img-fluid img-responsive" src="./asset/rollls/rolls_royce_black.jpg" alt=""></a>
                              ...
                              <div class="row"> 
                                ...
                                <div class="text-center">
                                   <?php
                                    ...
                                    {
                                    echo '<a href="booking.php"><button class="btn">BOOK CAR</button></a>';
                                   
                                }else
                                    {
                                      echo '<a href="login.php"><button class="btn">BOOK CAR</button></a>';  
                                    }
                                    ?>
                                </div>
