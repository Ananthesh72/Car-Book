...
<!----------------------------------------------------------------->
    <div class="main-content">
        <div class="wrap">
            <div class="main-box">
               <div class="box_wrapper"><h1>BMW X1 <a href="http://localhost/dbms/bmw.php"><img class="hot" src="./asset/pics/bmw_logo.png" alt=""></a></h1></div>  
            </div>
        </div>
    </div>
...
<!----------------------------------------------------------------->
    <div class="header-bottom">
        <div class="wrap">
            <div class="single">
                    <div class="box_wrapper"><h6>BMW X Series X1 Coupe : (Rs 1.29 Cr*)</h6>
                    </div>	
                    <div>
              
                            <a href="bmwx1.html"><img class="img-fluid img-responsive" src="./asset/pics/bmw_x1_2.jpg" alt=""></a>
