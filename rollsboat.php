...
<!----------------------------------------------------------------->
    <div class="main-content">
        <div class="wrap">
            <div class="main-box">
               <div class="box_wrapper"><h1>Rolls Royce Boat <img class="hot" src="./asset/rollls/Rolls-Royce_logo_PNG1.png" alt=""></h1></div>  
            </div>
        </div>
    </div>
...
<!----------------------------------------------------------------->
    <div class="header-bottom">
        <div class="wrap">
            <div class="single">
                    <div class="box_wrapper"><h6>Rolls Royce Boat Price: (Rs 2.56 Cr*)</h6>
                    </div>	
                    <div>
              
                            <a href="rollsbb.php"><img class="img-fluid img-responsive" src="./asset/rollls/rolls_royce_boat1.jpg" alt=""></a>
