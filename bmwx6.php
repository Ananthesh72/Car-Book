...
<!----------------------------------------------------------------->
    <div class="main-content">
        <div class="wrap">
            <div class="main-box">
               <div class="box_wrapper"><h1>BMW X6 <a href="http://localhost/dbms/bmw.php"><img class="hot" src="./asset/pics/bmw_logo.png" alt=""></a></h1></div>  
            </div>
        </div>
    </div>
...
<!----------------------------------------------------------------->
    <div class="header-bottom">
        <div class="wrap">
            <div class="single">
                    <div class="box_wrapper"><h6>BMW x Series X6 Coupe : (Rs 2.3 Cr*)</h6>
                    </div>	
                    <div>
              
                            <a href="bmwm4.php"><img class="img-fluid img-responsive" src="./asset/pics/X6_2.jpg" alt=""></a>
