...
<!----------------------------------------------------------------->
    <div class="main-content">
        <div class="wrap">
            <div class="main-box">
               <div class="box_wrapper"><h1>MERCEDES G Wagan <img class="hot" src="./asset/benz/mercedec_logo.png" alt=""></h1></div>  
            </div>
        </div>
    </div>
...
<!----------------------------------------------------------------->
    <div class="header-bottom">
        <div class="wrap">
            <div class="single">
                    <div class="box_wrapper"><h6>MERCEDES G Wagan: (Rs 97.5 LK*)</h6>
                    </div>	
                    <div>
              
                            <a href="benzg.php"><img class="img-fluid img-responsive" src="./asset/benz/mercedes_benz_g1.jpg" alt=""></a>
