...
.hot
  ...
  /* .button .col-sm-4.col-sm-4.btn1{
  background-color: #872734; /* Green */
  /* border: none;
  color: white;
  text-align: center;
...
<!----------------------------------------------------------------->
    <div class="main-content">
        <div class="wrap">
            <div class="main-box">
               <div class="box_wrapper"><h1>AUDI TT <img class="hot" src="./asset/audi/audi-logo.png" alt=""></h1></div>  
            </div>
        </div>
    </div>
...
<!----------------------------------------------------------------->
    <div class="header-bottom">
        <div class="wrap">
            <div class="single">
                    <div class="box_wrapper"><h6>AUDI TT: (Rs 2.56 Cr*)</h6>
                    </div>	
                    <div>
              
                            <a href="auditt.php"><img class="img-fluid img-responsive" src="./asset/audi/audi_tt_1.jpg" alt=""></a>
