...
<!----------------------------------------------------------------->
    <div class="main-content">
        <div class="wrap">
            <div class="main-box">
               <div class="box_wrapper"><h1>LAMBORGHINI Huracan <img class="hot" src="./asset/lamb/lambo_logo.png" alt=""></h1></div>  
            </div>
        </div>
    </div>
...
<!----------------------------------------------------------------->
    <div class="header-bottom">
        <div class="wrap">
            <div class="single">
                    <div class="box_wrapper"><h6>LAMBORGHINI Huracan: (Rs 1.29 Cr*)</h6>
                    </div>	
                    <div>
              
                            <a href="bmwx1.html"><img class="img-fluid img-responsive" src="./asset/lamb/lamborghini_huracan_1.jpg" alt=""></a>
