...
<!----------------------------------------------------------------->
    <div class="main-content">
        <div class="wrap">
            <div class="main-box">
               <div class="box_wrapper"><h1>AUDI Q6<img class="hot" src="./asset/audi/audi-logo.png" alt=""></h1></div>  
            </div>
        </div>
    </div>
...
<!----------------------------------------------------------------->
    <div class="header-bottom">
        <div class="wrap">
            <div class="single">
                    <div class="box_wrapper"><h6>AUDI Q6 : (Rs 2.56 Cr*)</h6>
                    </div>	
                    <div>
              
                            <a href="audiq6.php"><img class="img-fluid img-responsive" src="./asset/audi/audi_q6_1.jpg" alt=""></a>
