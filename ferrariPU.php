...
<!----------------------------------------------------------------->
    <div class="header-bottom">
        <div class="wrap">
            <div class="single">
                    <div class="box_wrapper"><h6>Ferrari Purosangue: (Rs 2.56 Cr*)</h6>
                    </div>	
                    <div>
              
                            <a href="./asset/ferrari/Ferrai Purosangue.jpg"><img class="img-fluid img-responsive" src="./asset/ferrari/Ferrai Purosangue.jpg" alt=""></a>
